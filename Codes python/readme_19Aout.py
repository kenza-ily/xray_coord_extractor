...
class Application(object):
    ...
    def openradio(self):
        ...
        # Radionumber_lbl=Label(frame,bg=white_bg,text="Traitement de la radio n°"+str(self.radionumber),font=("Arial", 10,"italic"))
        # Radionumber_lbl.pack()
        ...
        Database_bttn=Button(frame,text='Afficher le tableau des données',bg=white_bg,command=lambda: database(self))
    ...
    def packleftbuttons(self):    
        ...
        Button(f2, text="Rectangle",font=("Arial", 12),command=lambda: setrectangle(self)).pack()
        Button(f2, text="Point",font=("Arial", 12),bg=white_bg,command=lambda: setpoint(self)).pack()
        Label(f2, text="",bg=white_bg).pack()
        Button(f2, text="Crayon",font=("Arial", 12),bg=white_bg,command=lambda: setpencil(self)).pack()
        Button(f2, text="Legender les vertèbres",font=("Arial", 12),bg=white_bg,command=lambda: settext(self)).pack()
    ...
    #     Radionumber_lbl['text']="Traitement de la radio n° "+str(self.radionumber)
    ...
    #     #On réinitalise les base de données
    #     global coordo_pointeur; coordo_pointeur=[] #Coordonnées des points
    #     global coordo_ligne; coordo_ligne=[] #Coordonnées des lignes 
    #     global coordo_oval; coordo_oval=[] #Coordonnées des cercles : centre du cercle pour l'instant
    #     global coordo_rectangle; coordo_rectangle=[] #Coordonnées des rectangles
