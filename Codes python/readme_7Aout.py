...
################## ETAPE 1 
        ...
        def openradio(self):
            ...
            #Lignes
            canvas_radio.bind("<Motion>", motion(self,event(self)))
            lines1_bind =canvas_radio.bind("<ButtonPress-1>", left_but_down(self,event(self)))
            lines2_bind=canvas_radio.bind("<ButtonRelease-1>", left_but_up(self,event(self)))
